...
class Game():
    def __init__(self):
        ...
        self.image_icon = pygame.image.load("model/menu/Logo1.png")
        ...
        self.back = pygame.image.load("model/menu/Logo1.png").convert_alpha()
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if self.main_menu.creditsx - 70 <= pos[
                    ...
                    self.running, self.playing = False, False
                    self.curr_menu.run_display = False
                if self.main_menu.optionsx - 70 <= pos[
                    0] <= self.main_menu.optionsx + 70 and self.main_menu.optionsy - 10 <= pos[
                    1] <= self.main_menu.optionsy + 10:
                    self.running, self.playing = False, False
                    self.curr_menu.run_display = False
